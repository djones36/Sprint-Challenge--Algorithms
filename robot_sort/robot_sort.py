class SortingRobot:
    ...
    def sort(self):
        ...
        """
        # Fill this out
        # Start by grabbing first item( robot has nothing in its hand index 0)
        # Will run as long as the robot is turned on
        #  move right to compare the list itmes to what is in its hand, item is greater than list itme it will swap
